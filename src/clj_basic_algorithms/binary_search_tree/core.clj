...
;; bstl-arr -- tree implementation with lists of size 1 as leaf nodes and
;; singly linked list as a main data structure
(def bstl-arr '(4 ((2 ((1) (3))) (5))))

;; bstv-int -- tree implementation with integers as leaf nodes and vector as a
;; main data structure
(def bstv-int [4 [[2 [1 3]] 5]])

;; bstv-arr -- tree implementation with vectors of size 1 as leaf nodes and
;; vector as a main data structure
(def bstv-arr [4 [[2 [[1] [3]]] [5]]])
